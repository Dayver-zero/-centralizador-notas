...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($accion === 'crear') {
        ...
        header("Location: /centralizador_notas/view/admin/gestion_docentes.php?msg=created");
        exit;
    } elseif ($accion === 'editar') {
        $model->actualizar($_POST['id'], $_POST['ci'], $_POST['nombre'], $_POST['email'], $_POST['telefono'], $_POST['estado']);
        header("Location: /centralizador_notas/view/admin/gestion_docentes.php?msg=updated");
        exit;
    } elseif ($accion === 'eliminar') {
        $model->eliminar($_POST['id']);
        header("Location: /centralizador_notas/view/admin/gestion_docentes.php?msg=deleted");
        exit;
    }
}
?>
    ...
    <div class="container">
        ...
        <?php if (isset($_GET['msg'])): ?>
            <div class="alert alert-success">
                <?php
                switch ($_GET['msg']) {
                    case 'created': echo 'Docente creado exitosamente.'; break;
                    case 'updated': echo 'Docente actualizado exitosamente.'; break;
                    case 'deleted': echo 'Docente eliminado exitosamente.'; break;
                }
                ?>
            </div>
        <?php endif; ?>
