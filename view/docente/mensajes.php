<?php
session_start();
if (!isset($_SESSION['user_id']) || !in_array($_SESSION['rol'], ['docente', 'estudiante'], true)) { header("Location: /centralizador_notas/index.php?error=session"); exit; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: /centralizador_notas/view/" . $rol . "/mensajes.php?msg=sent");
    exit;
}
